...
void main() {
  ...
  p = rotate2d(
    radians(uRotation) + time * uRotationSpeed
  ) * p;
  ...
  float noise =
    (layeredGrain(gl_FragCoord.xy) - 0.5) *
    uGrain;
...
const GhostFibers: FC<GhostFibersProps> = ({
  ...
  useEffect(() => {
    ...
    const setSize = () => {
      ...
      program.uniforms.uResolution.value[0] =
        gl.drawingBufferWidth;

      program.uniforms.uResolution.value[1] =
